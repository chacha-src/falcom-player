...
void CDouga::OnNcRButtonDown(UINT nHitTest, CPoint point)
{
	...
	if (ev)
	{
		...
		}
		{
			...
			{
				CString buf;
				buf.Format(L"音声40:%s", streamname[39]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(39, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声39:%s", streamname[38]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(38, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声38:%s", streamname[37]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(37, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声37:%s", streamname[36]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(36, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声36:%s", streamname[35]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(35, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声35:%s", streamname[34]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(34, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声34:%s", streamname[33]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(33, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声33:%s", streamname[32]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(32, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声32:%s", streamname[31]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(31, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声31:%s", streamname[30]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(30, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声30:%s", streamname[29]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(29, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声29:%s", streamname[28]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(28, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声28:%s", streamname[27]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(27, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声27:%s", streamname[26]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(26, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声26:%s", streamname[25]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(25, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声25:%s", streamname[24]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(24, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声24:%s", streamname[23]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(23, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声23:%s", streamname[22]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(22, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声22:%s", streamname[21]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(21, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声21:%s", streamname[20]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(20, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声20:%s", streamname[19]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(19, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声19:%s", streamname[18]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(18, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声18:%s", streamname[17]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(17, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声17:%s", streamname[16]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(16, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声16:%s", streamname[15]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(15, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声15:%s", streamname[14]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(14, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声14:%s", streamname[13]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(13, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声13:%s", streamname[12]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(12, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声12:%s", streamname[11]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(11, &mii, TRUE);
			}
			{
				CString buf;
				buf.Format(L"音声11:%s", streamname[10]);
				MENUITEMINFO mii = { sizeof(mii) };
				mii.fMask = MIIM_STRING;
				mii.dwTypeData = buf.GetBuffer();
				sub2->SetMenuItemInfo(10, &mii, TRUE);
			}
			{
				CString buf;
		...
		if (audionum <= 39) {
			menu.DeleteMenu(ID_ST40, MF_BYCOMMAND);
		}
		if (audionum <= 38) {
			menu.DeleteMenu(ID_ST39, MF_BYCOMMAND);
		}
		if (audionum <= 37) {
			menu.DeleteMenu(ID_ST38, MF_BYCOMMAND);
		}
		if (audionum <= 36) {
			menu.DeleteMenu(ID_ST37, MF_BYCOMMAND);
		}
		if (audionum <= 35) {
			menu.DeleteMenu(ID_ST36, MF_BYCOMMAND);
		}
		if (audionum <= 34) {
			menu.DeleteMenu(ID_ST35, MF_BYCOMMAND);
		}
		if (audionum <= 33) {
			menu.DeleteMenu(ID_ST34, MF_BYCOMMAND);
		}
		if (audionum <= 32) {
			menu.DeleteMenu(ID_ST33, MF_BYCOMMAND);
		}
		if (audionum <= 31) {
			menu.DeleteMenu(ID_ST32, MF_BYCOMMAND);
		}
		if (audionum <= 30) {
			menu.DeleteMenu(ID_ST31, MF_BYCOMMAND);
		}
		if (audionum <= 29) {
			menu.DeleteMenu(ID_ST30, MF_BYCOMMAND);
		}
		if (audionum <= 28) {
			menu.DeleteMenu(ID_ST29, MF_BYCOMMAND);
		}
		if (audionum <= 27) {
			menu.DeleteMenu(ID_ST28, MF_BYCOMMAND);
		}
		if (audionum <= 26) {
			menu.DeleteMenu(ID_ST27, MF_BYCOMMAND);
		}
		if (audionum <= 25) {
			menu.DeleteMenu(ID_ST26, MF_BYCOMMAND);
		}
		if (audionum <= 24) {
			menu.DeleteMenu(ID_ST25, MF_BYCOMMAND);
		}
		if (audionum <= 23) {
			menu.DeleteMenu(ID_ST24, MF_BYCOMMAND);
		}
		if (audionum <= 22) {
			menu.DeleteMenu(ID_ST23, MF_BYCOMMAND);
		}
		if (audionum <= 21) {
			menu.DeleteMenu(ID_ST22, MF_BYCOMMAND);
		}
		if (audionum <= 20) {
			menu.DeleteMenu(ID_ST21, MF_BYCOMMAND);
		}
		if (audionum <= 19) {
			menu.DeleteMenu(ID_ST20, MF_BYCOMMAND);
		}
		if (audionum <= 18) {
			menu.DeleteMenu(ID_ST19, MF_BYCOMMAND);
		}
		if (audionum <= 17) {
			menu.DeleteMenu(ID_ST18, MF_BYCOMMAND);
		}
		if (audionum <= 16) {
			menu.DeleteMenu(ID_ST17, MF_BYCOMMAND);
		}
		if (audionum <= 15) {
			menu.DeleteMenu(ID_ST16, MF_BYCOMMAND);
		}
		if (audionum <= 14) {
			menu.DeleteMenu(ID_ST15, MF_BYCOMMAND);
		}
		if (audionum <= 13) {
			menu.DeleteMenu(ID_ST14, MF_BYCOMMAND);
		}
		if (audionum <= 12) {
			menu.DeleteMenu(ID_ST13, MF_BYCOMMAND);
		}
		if (audionum <= 11) {
			menu.DeleteMenu(ID_ST12, MF_BYCOMMAND);
		}
		if (audionum <= 10) {
			menu.DeleteMenu(ID_ST11, MF_BYCOMMAND);
		}
		if (audionum <= 9) {
		...
		if (streamname2[39] == "") {
			menu.DeleteMenu(ID_ETC40, MF_BYCOMMAND);
		}
		if (streamname2[38] == "") {
			menu.DeleteMenu(ID_ETC39, MF_BYCOMMAND);
		}
		if (streamname2[37] == "") {
			menu.DeleteMenu(ID_ETC38, MF_BYCOMMAND);
		}
		if (streamname2[36] == "") {
			menu.DeleteMenu(ID_ETC37, MF_BYCOMMAND);
		}
		if (streamname2[35] == "") {
			menu.DeleteMenu(ID_ETC36, MF_BYCOMMAND);
		}
		if (streamname2[34] == "") {
			menu.DeleteMenu(ID_ETC35, MF_BYCOMMAND);
		}
		if (streamname2[33] == "") {
			menu.DeleteMenu(ID_ETC34, MF_BYCOMMAND);
		}
		if (streamname2[32] == "") {
			menu.DeleteMenu(ID_ETC33, MF_BYCOMMAND);
		}
		if (streamname2[31] == "") {
			menu.DeleteMenu(ID_ETC32, MF_BYCOMMAND);
		}
		if (streamname2[30] == "") {
			menu.DeleteMenu(ID_ETC31, MF_BYCOMMAND);
		}
		if (streamname2[29] == "") {
			menu.DeleteMenu(ID_ETC30, MF_BYCOMMAND);
		}
		if (streamname2[28] == "") {
			menu.DeleteMenu(ID_ETC29, MF_BYCOMMAND);
		}
		if (streamname2[27] == "") {
			menu.DeleteMenu(ID_ETC28, MF_BYCOMMAND);
		}
		if (streamname2[26] == "") {
			menu.DeleteMenu(ID_ETC27, MF_BYCOMMAND);
		}
		if (streamname2[25] == "") {
			menu.DeleteMenu(ID_ETC26, MF_BYCOMMAND);
		}
		if (streamname2[24] == "") {
			menu.DeleteMenu(ID_ETC25, MF_BYCOMMAND);
		}
		if (streamname2[23] == "") {
			menu.DeleteMenu(ID_ETC24, MF_BYCOMMAND);
		}
		if (streamname2[22] == "") {
			menu.DeleteMenu(ID_ETC23, MF_BYCOMMAND);
		}
		if (streamname2[21] == "") {
			menu.DeleteMenu(ID_ETC22, MF_BYCOMMAND);
		}
		if (streamname2[20] == "") {
			menu.DeleteMenu(ID_ETC21, MF_BYCOMMAND);
		}
		if (streamname2[19] == "") {
			menu.DeleteMenu(ID_ETC20, MF_BYCOMMAND);
		}
		if (streamname2[18] == "") {
			menu.DeleteMenu(ID_ETC19, MF_BYCOMMAND);
		}
		if (streamname2[17] == "") {
			menu.DeleteMenu(ID_ETC18, MF_BYCOMMAND);
		}
		if (streamname2[16] == "") {
			menu.DeleteMenu(ID_ETC17, MF_BYCOMMAND);
		}
		if (streamname2[15] == "") {
			menu.DeleteMenu(ID_ETC16, MF_BYCOMMAND);
		}
		if (streamname2[14] == "") {
			menu.DeleteMenu(ID_ETC15, MF_BYCOMMAND);
		}
		if (streamname2[13] == "") {
			menu.DeleteMenu(ID_ETC14, MF_BYCOMMAND);
		}
		if (streamname2[12] == "") {
			menu.DeleteMenu(ID_ETC13, MF_BYCOMMAND);
		}
		if (streamname2[11] == "") {
			menu.DeleteMenu(ID_ETC12, MF_BYCOMMAND);
		}
		if (streamname2[10] == "") {
			menu.DeleteMenu(ID_ETC11, MF_BYCOMMAND);
		}
		if (streamname2[9] == "") {
...
void CDouga::OnST11()
{
	st12 = 11;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 10, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST12()
{
	st12 = 12;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 11, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST13()
{
	st12 = 13;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 12, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST14()
{
	st12 = 14;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 13, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST15()
{
	st12 = 15;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 14, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST16()
{
	st12 = 16;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 15, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST17()
{
	st12 = 17;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 16, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST18()
{
	st12 = 18;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 17, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST19()
{
	st12 = 19;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 18, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST20()
{
	st12 = 20;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 19, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST21()
{
	st12 = 21;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 20, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST22()
{
	st12 = 22;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 21, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST23()
{
	st12 = 23;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 22, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST24()
{
	st12 = 24;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 23, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST25()
{
	st12 = 25;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 24, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST26()
{
	st12 = 26;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 25, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST27()
{
	st12 = 27;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 26, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST28()
{
	st12 = 28;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 27, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST29()
{
	st12 = 29;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 28, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST30()
{
	st12 = 30;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 29, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST31()
{
	st12 = 31;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 30, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST32()
{
	st12 = 32;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 31, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST33()
{
	st12 = 33;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 32, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST34()
{
	st12 = 34;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 33, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST35()
{
	st12 = 35;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 34, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST36()
{
	st12 = 36;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 35, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST37()
{
	st12 = 37;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 36, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST38()
{
	st12 = 38;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 37, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST39()
{
	st12 = 39;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 38, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
void CDouga::OnST40()
{
	st12 = 40;
	if (pGraphBuilder && iam) {
		iam->Enable(au + 39, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 10, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 11, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 12, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 13, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 14, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 15, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 16, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 17, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 18, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 19, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 20, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 21, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 22, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 23, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 24, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 25, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 26, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 27, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 28, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 29, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 30, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 31, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 32, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 33, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 34, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 35, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 36, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 37, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 38, AMSTREAMSELECTENABLE_ENABLE);
	}
}
...
{
	if (pGraphBuilder && iam) {
		iam->Enable(etc + 39, AMSTREAMSELECTENABLE_ENABLE);
	}
}
